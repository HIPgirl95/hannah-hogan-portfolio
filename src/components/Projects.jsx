          ...
          <Modal show={showCaseStudy} onHide={handleClose} size="lg">
            ...
            <Modal.Body>
              <>
                ...
                <div className="d-flex align-items-start mb-4">
                  <p className="mb-4">
                    This project marked my introduction to mobile app development, Firebase, and real-time messaging. I developed a mobile chat application using React Native and Expo that enables users to send and receive messages instantly. The app also supports image and location sharing, with proper permission handling. Firebase powers the authentication and data storage, while the chat interface is built using GiftedChat.
                  </p>
                  <Image
                ...
                <div className="mb-4">
                  ...
                  <div className="d-flex align-items-start mb-4">
                    <div>
                      ...
                      I made use of React's <strong>useState</strong> hook to allow users to change the background color of the chat interface. This feature adds a personal touch to the app, allowing users to customize their experience.
                    </div>
                    <Image
                  ...
                  <div className="d-flex align-items-start mb-4">
                    <div>
                      <strong className="colored-text">Cached Messages:</strong> The chat screen lets users send and receive messages in real time using Firebase Firestore, while also saving recent messages on the device. When the user is online, new messages appear instantly and are saved locally in case the connection drops. If the user is offline, the app loads the most recent messages from the device so they can still read past conversations. This makes the chat experience fast, reliable, and available even without internet access.
                    </div>
                  </div>
                  ...
                  <div className="d-flex align-items-start mb-4">
                    <div>
                      <strong className="colored-text">Asking Permission:</strong> The app asks for permission to access certain device features only when needed, keeping the experience intuitive and respectful of user privacy. For example, permission to access the photo library is requested only when a user taps the image upload button, and location access is requested only if the user chooses to share their location in a message. These prompts are built to be clear and contextual, following platform best practices to ensure users understand why a permission is being asked at the moment it's relevant.
                    </div>
                  </div>
                  ...
                  <div className="d-flex align-items-start mb-4" style={{ gap: "2rem" }}>
                    ...
                    <div style={{ flex: 2 }}>
                      <strong className="colored-text">Actions:</strong> Once permission has been granted, users can enhance their chats by sending photos directly from their device and optionally sharing their current location. These features make conversations more expressive and helpful—whether it’s sharing a picture from your day or letting a friend know where to meet. Both features are entirely optional and only activate when the user chooses to use them.
                    </div>
                  </div>
                ...
                <ul className="mb-4">
                  <li>
                    The user can input their name at the beginning of the app, which is then used to identify them in the chat. This is a simple but effective way to personalize the chat experience.
                  </li>
                  <li>
                    The user can choose whether to select a picture from their device or take a new one using the camera. This is done using the <strong>Image Picker</strong> library, which provides a simple interface for selecting images.
                  </li>
                </ul>
                ...
                <h4 className="colored-text">Development Journey</h4>
                <p className="mb-3">
                  Though it was simple, I enjoyed the challenge of building a mobile app from scratch. I had to learn how to use React Native and Expo, which was a new experience for me. I also had to learn how to use Firebase for data storage, which was a bit tricky at first, but I eventually got the hang of it. The biggest challenge was getting the chat interface to work properly, but I was able to use the GiftedChat library to make it easier.
                </p>
                ...
                <ul className="mb-4">
                  <li>
                    <strong>Second User:</strong> In order to test the app, I needed to have a second user to chat with. I made use of an android Emulator, since I have an iphone, allowing me to test both major types of phones. This allowed me to see how the app would behave on different devices and ensure that it was responsive and functional across platforms.
                  </li>
                  <Image
                  ...
                  />
                  <li>
                    <strong>Firebase Storage:</strong> I had to learn how to use Firebase Storage to store images and other media files. This was a bit tricky at first, but I was able to find some good documentation and examples online that helped me get started. I also had to learn how to use the Firebase Realtime Database to store messages, which was a bit different from what I was used to with traditional databases.
                  </li>
                </ul>
                ...
                <h4 className="colored-text">Outcome & Next Steps</h4>
                <p className="mb-2">
                  All in all, this was a pretty simple app, but it was a great introduction to mobile app development. I learned a lot about how to build a mobile app from scratch, and I was able to apply some of the skills I had learned in my previous projects. I would like to add more features, such as push notifications and a way to filter messages by user or date. I would also like to improve the UI and make it more visually appealing.
                </p>
              </>
            </Modal.Body>
          </Modal>
